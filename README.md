...
The data used in this analysis is provided in the `datasets` folder. It contains information about the monthly number of and the number of deaths due to childbirth fever for each year from 1841 to 1849 in the two maternity wards.
